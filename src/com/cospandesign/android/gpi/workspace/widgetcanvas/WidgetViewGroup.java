...
public class WidgetViewGroup extends ViewGroup implements MessageEndPoint
{
	...
	//Constructor
	public WidgetViewGroup(Context context, Widget widget){
		super(context);
		mWidget = widget;
	...
	public WidgetViewGroup(Context context, WorkspaceEntity parent){
		super(context);
...
//TODO add the ability to add Labels, buttons, go to full screen, etc...
	...
	protected boolean checkLayoutParams(ViewGroup.LayoutParams p){
		return p instanceof WidgetViewGroup.LayoutParams;
	}
	@Override
	public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs){
		return new WidgetViewGroup.LayoutParams(getContext(), attrs);
	}
	@Override
	protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p){
		return new WidgetViewGroup.LayoutParams(p);
	}
