...
public class AndroidPreassure extends AndroidSensor {

	public static String PREASSURE = "Preassure";
	private volatile float mPreassure = 0.0f;
	
	public AndroidPreassure(String name, String info, Integer image,
		...
		addOutputDataChannel(PREASSURE, Float.class);
	}
	...
	protected void AndroidSensorChangedFunction(SensorEvent event) {
		...
		*/
		mPreassure = event.values[0];
	}

	@Override
	protected void updateSensorFunction() {
		final float preassure = mPreassure;
		outputData(PREASSURE, preassure);
	}

	/*
	@Override
	protected void SensorHandlerHandleMessage(Message msg) {
		OutputData(PREASSURE, (Float) msg.obj);
	}
*/
