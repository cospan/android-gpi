...
import com.cospandesign.android.gpi.widget.chart.ManifestViewFloatGraph.AddPointStruct;
import com.cospandesign.android.gpi.workspace.WorkspaceEntity;

public class WidgetDoubleChart extends Widget
{
	...
	ManifestViewFloatGraph mFloatGraphView;
	...
	public WidgetDoubleChart(String name, String info, Integer image,
	...
	public void guiInitialization(WorkspaceEntity workspaceEntity) {
		...
		setDefualtViewDimensions(100, 100);
		mFloatGraphView = new ManifestViewFloatGraph(mContext);
